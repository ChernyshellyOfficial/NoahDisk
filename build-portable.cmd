...
cd /d "%~dp0"
echo.
echo === Building portable SpaceSaver.exe ===
...
echo.
if exist "dist-gui-portable\SpaceSaver.exe" echo DONE: %~dp0dist-gui-portable\SpaceSaver.exe
if not exist "dist-gui-portable\SpaceSaver.exe" echo BUILD FAILED - check internet and that .NET 9 SDK is installed.
echo.
pause
