...
- **Глобальный скан** — кнопка «Глобальный скан»: полностью сканирует папку и **раскладывает всё значимое в один вид** — отдельные игры (в т.ч. из `steam/steamapps/common`), программы, тяжёлые файлы, куда бы глубоко они ни лежали. Спускается сквозь папки-контейнеры и всплывает настоящими «единицами». Хлебные крошки «← Обычный вид» возвращают назад; двойной клик по элементу — перейти к нему. Предупреждает, что для целого диска это дольше обычного.
