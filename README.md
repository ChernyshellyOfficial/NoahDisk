...
Запуск: двойной клик по `dist-gui\SpaceSaver.exe` (нужен установленный **.NET 9 Desktop Runtime**). Портативная версия из [releases](https://github.com/ChernyshellyOfficial) — единый exe, рантайм не нужен.
